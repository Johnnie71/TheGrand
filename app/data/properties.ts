...
export const properties: Property[] = [
  {
    ...
    city: "New York",
    description: "The Grand Skyline Tower stands as a beacon of modern luxury in the heart of the city. With its sleek glass facade and cutting-edge amenities, it offers residents an unparalleled living experience. Each home is meticulously designed with premium finishes, floor-to-ceiling windows, and smart home technology. The building features a rooftop infinity pool, private cinema, state-of-the-art fitness center, and 24/7 concierge service, ensuring that every need is met with the highest standard of service.",
  ...
  },
  {
    ...
    city: "Chicago",
    description: "The Grand Metropolitan redefines urban living with its innovative design and comprehensive amenities. Located in the heart of the city, this striking tower offers residents the perfect combination of convenience, comfort, and style. The thoughtfully designed residences feature open floor plans, custom cabinetry, and integrated appliances that create a seamless living experience. The building boasts an impressive suite of amenities including a sky lounge, co-working spaces, and a fully equipped fitness center. With its prime location and exceptional offerings, The Grand Metropolitan represents the pinnacle of contemporary city living.",
  ...
  },
  {
    ...
    city: "Los Angeles",
    description: "The Grand Oasis is a sanctuary of tranquility and luxury in the midst of the bustling city. This exclusive collection of residences is set within lush, landscaped grounds that create a serene atmosphere reminiscent of a private resort. The homes are designed with a focus on indoor-outdoor living, featuring retractable glass walls, private terraces, and natural materials throughout. Residents enjoy access to a comprehensive wellness center, meditation gardens, and an outdoor pool surrounded by cabanas. The Grand Oasis offers a unique opportunity to experience the perfect balance of city living and peaceful retreat.",
